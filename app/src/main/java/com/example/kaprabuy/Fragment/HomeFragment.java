package com.example.kaprabuy.Fragment;
...
//    ArrayList<DashboardModel> dashboardList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        storyList.add(new StoryModel(R.drawable.dennis,R.drawable.ic_video_camera,R.drawable.profile,"Darshil"));
        storyList.add(new StoryModel(R.drawable.nature_dordogne,R.drawable.ic_live,R.drawable.deaf,"Bhuva"));
        storyList.add(new StoryModel(R.drawable.profile1,R.drawable.ic_video_camera,R.drawable.dennis,"Bhuva"));
